...
//       resolve({
//         floor: Object.assign(element.all(by.tagName('datatable-row-wrapper')).last().all(by.className('datatable-body-cell-label')).get(0).getText()),
//         tags: Object.assign(element.all(by.tagName('datatable-row-wrapper')).last().all(by.className('datatable-body-cell-label')).get(1).getText()),
//         users: Object.assign(element.all(by.tagName('datatable-row-wrapper')).last().all(by.className('datatable-body-cell-label')).get(2).getText())
//       });
//     });
//   }
//
